...
- Enabled: no — PDF-only (non-PDF `eit` 500s); positional PDF parser (`olympia_smartgov_reports`) built 2026-07-19, shadow run pending. Capture-fed — auto-`fetch()` dead-letters against the session-bound `eid` gate.
