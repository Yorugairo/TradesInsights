...
|---|---|---|---|---|
| 0 | Decisions + offline spike | A written decision record, and proof on a real phone in a real no-signal building that capture → reconnect → sync works | pending | — |
| 1 | Mobile shell + digest home | The owner can install the app and read their week on a phone | pending | — |
